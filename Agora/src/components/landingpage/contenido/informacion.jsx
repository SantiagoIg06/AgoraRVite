...
return (
    <>
        ...
        <div class="contentInfBasic">
            <div>
                <div class="infBasic">
                    <img class="imgSmall" src="/assets/images/logosSimbolos/trabajos.png" alt="Trabajos" />
        ...
        <div>
            <div class="infBasic">
                <img class="imgSmall" src="/assets/images/logosSimbolos/actualizacion.png" alt="Actualizacion" />
        ...
        <div>
            <div class="infBasic">
                <img class="imgSmall" src="/assets/images/logosSimbolos/solo.png" alt="Solo" />
                <h4>No estas solo</h4>
                <img class="imgSmall" src="/assets/images/logosSimbolos/solo.png" alt="Solo" />
            </div>
            <div class="InfBasicParrafo">
