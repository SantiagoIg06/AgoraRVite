    ...
    <>
        ...
        <div>
            <div className="infBasic">
                <img className="imgSmall" src="/assets/images/logosSimbolos/conocimiento.png" alt="Conocimiento" />
        ...
        <div>
            <div className="infBasic">
                <img className="imgSmall" src="/assets/images/logosSimbolos/precio.png" alt="Precio" />
        ...
        <div>
            <div className="infBasic">
                <img className="imgSmall" src="/assets/images/logosSimbolos/seguridad.png" alt="Seguridad" />
